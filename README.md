...
Além da ferramenta de consulta ao banco de dados de estoque, o projeto inclui uma **tool personalizada para consulta do horário de funcionamento da lojaa**.
